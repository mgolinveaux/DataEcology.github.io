...
function loadModels() {
  ...
  loader.load( 'models/crystal/scene.gltf', gltf => onLoad( gltf, parrotPosition, newStandard, "MeshName"), onProgress, onError );
...
const object = scene.getObjectByName("MeshName"); //not most efficent way
console.log(object);

if(object){
    object.rotation.y+= guiControls.rotationY;
    object.rotation.x+= guiControls.rotationX;
