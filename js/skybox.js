...
function createSkybox(){
  ...
  scene.background = new THREE.CubeTextureLoader()
					.setPath( 'js/three.js-master/examples/textures/cube/Park2/' )
...
function loadModels() {
  ...
  loader.load( 'models/crystal/scene.gltf', gltf => onLoad( gltf, parrotPosition, newStandard), onProgress, onError );
