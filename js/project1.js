...
function init() {
  ...
  const material = new THREE.MeshStandardMaterial( { color: 0xb50000 } );
  const material2 = new THREE.MeshStandardMaterial( { color:  0x2C3B79 } );
  const material3 = new THREE.MeshStandardMaterial ({ color: 0x026003});
