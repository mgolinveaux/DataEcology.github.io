...
function loadModels() {
  ...
  loader.load( 'models/crystal/scene.gltf', gltf => onLoad( gltf, Position2, newStandard), onProgress, onError );

  const Position3 = new THREE.Vector3( 0,0, 0 );
  loader.load( 'models/crystal/scene.gltf', gltf => onLoad( gltf, Position3, SkyboxMaterial), onProgress, onError );

  const Position4 = new THREE.Vector3( 40,0, 0 );
  loader.load( 'models/crystal/scene.gltf', gltf => onLoad( gltf, Position4, refractorySkybox), onProgress, onError );
